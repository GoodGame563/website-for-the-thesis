...
const LoadingAnimation = () => {
    ...
    return (
        <motion.div
            ...
            exit={{ opacity: 0 }}
        >
            <div className={styles.loadingText}>Поиск товаров{dots}</div>
        </motion.div>
    );
};
...
export default function Overlay({
    ...
    unusedWords: initialUnusedWords = [],
    onWordChange,
    isGenerating,
    isSearchingProducts,
    ...
    return (
        ...
        >
            ...
            <Button className={styles.closeBtn} onClick={handleClose} disabled={isSearchingProducts}>
                <motion.svg
                    viewBox="0 0 24 24"
            ...
            <motion.div className={styles.container} variants={containerVariants}>
                ...
                <motion.div className={styles.keywordContainer} variants={containerVariants}>
